  ...
  */
  async save({ request }: { request: Request }) {
    ...
    const createUploadResponse = await fetch(
      `https://1cwj4ysj5h.execute-api.ap-southeast-2.amazonaws.com/question/create?q1=${q1}&q2=${q2}&q3=${q3}&q4=${q4}&q5=${q5}&q6=${q6}&q7=${q7}&q8=${q8}&q9=${q9}&q10=${q10}&q11=${q11}&q12=${q12}`, {
      method: 'POST',
