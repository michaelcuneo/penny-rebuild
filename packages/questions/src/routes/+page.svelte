		...
		$client.on('message', (_topic, message) => {
			...
			if (_topic === BUTTON_2_TOPIC && message.toString() === "1") {
				...
				if (!accepted) {
					...
					button1Text = "CANCEL SURVEY";
					button2Text = "RECORD ANSWER";
					button3Text = "SUBMIT ANSWER";
				}
...
{#if accepted}
	<div class="question poetsen-one-regular">
		<div class="question-text" transition:fade>
			...
			{/each}
			<div>Respond by speaking the numbers that correspond to your answer, or just freeform it and say anything you like.</div>
	...
	<div class="question poetsen-one-regular">
		<div class="question-text" transition:fade>
			<Typewriter cursor={false} mode="cascade">
				...
				<p>Participation in this survey is voluntary. If you do not want to take part, you do not have to. If you want to participate you can respond to the survey by selecting an answer on the touchscreen, by speaking your responses into the microphone. </p>			
				<h4>Privacy statement.</h4>
				<p>All responses are anonymous. Voice recordings will be automatically converted to text and the audio will not be stored.</p>
				...
				<h4>To participate here using this henge, proceed with the button corresponding to the tick.</h4>
			</Typewriter>
		</div>
		<div class="qr-codes">
			<div class="row">
...
<style>
  ...
  font-size: 3.2rem;
  letter-spacing: 5px;
  text-shadow: -1px -1px 0px #313639,
