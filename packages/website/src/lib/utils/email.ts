export const email = (data: ContactMailer) => {
  return `
  <div>
    <h2 style="color: #183D3D;">Hello Cassie, someone has sent you an email from your business website 'Walking With You'.</h2>
    <div style="background-color: #f7f1f1; color: #040D12; border: 1px solid #040D12; padding: 1rem; border-radius: 5px;">
      ...
      <h2>Phone: <a href="tel:${data.phone}">${data.phone}</a></h2>
      <h2>Email: ${data.email}</h2>
      <h2>Message: ${data.message}</h2>
      <h3 style="font-style: italic; color: #183D3D;">DO NOT REPLY TO THIS MESSAGE - CLICK THE BUTTON BELOW TO REPLY, OR CLICK THE PHONE NUMBER TO CALL DIRECTLY</h3>
